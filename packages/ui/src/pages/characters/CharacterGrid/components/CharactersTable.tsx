...
function CharacterRows(characters: CharacterModel[], handleShowDeleteModal: (id: number) => void, handleShowDuplicateModal: (id: number) => void) {
...
export function CharactersTable({characters, isLoading, handleShowDeleteModal, handleShowDuplicateModal}: Props) {
    if (isLoading) {
        return <Loading/>;
    }
    ...
    return (
        <Table striped hover size="sm" responsive>
            ...
            <tbody>{CharacterRows(characters, handleShowDeleteModal, handleShowDuplicateModal)}</tbody>
        </Table>
    );
}
